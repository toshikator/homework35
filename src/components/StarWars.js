  ...
  return (
    <section className={"star-wars"}>
      <div className={"crawl"}>
        ...
        by George Lucas, which began with the eponymous 1977 film[b] and quickly
        ...
        Wars is one of the highest-grossing media franchises of all time. The
        ...
        (2019). All nine films of the "Skywalker Saga" were nominated for
        Academy Awards, with wins going to the first two releases. Together with
        the theatrical live action "anthology" films Rogue One (2016) and Solo
        (2018), the combined box office revenue of the films equated to over
        US$10 billion, which makes it the second-highest-grossing film franchise
        of all time. Additional upcoming films are in the works, including an
        untitled movie from Taika Waititi and Rogue Squadron directed by Patty
        Jenkins, both currently without release dates.
      </div>
    </section>
  );
};
